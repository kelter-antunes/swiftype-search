...
;
  ...
  var defaultResultRenderFunction = function(ctx, results) {
    ...
    $.each(results, function(document_type, items) {
	  ...
	  ctx.registerResult( $('<li class="result swtpbutton" style="position: relative; width: auto; padding-left: 0px; padding-right: 0px; border-left-width: 0px; border-left-style: solid; border-left-color: rgb(230, 230, 230); border-bottom-width: 0px; border-bottom-style: solid; border-bottom-color: rgb(230, 230, 230);"><a href="http://www.outsystems.com/search/#stq='+$('input[name=s]').val()+'&stp=1"><p>'+swiftype_localize.all_results_text+'</p></a></li>').appendTo($list));
  ...
  $(function() {
    ...
    var swiftypeOptions = {
      ...
      renderFunction: function(document_type, item) {
        ...
        return '<p class="title">' + title + '</p><p class="body">'+Swiftype.htmlEscape(item['body'])+'</p>';
       }
    };
